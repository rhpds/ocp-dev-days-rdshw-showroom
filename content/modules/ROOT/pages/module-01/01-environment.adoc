...
TIP: Keep these credentials handy -- you will need them several times during the workshop.
...
Continue to xref:module-01/02-developer-experience.adoc[The Developer Experience] to begin the hands-on labs.
